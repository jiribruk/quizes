...
ActiveRecord::Schema[8.0].define(version: 2025_11_22_191302) do
  ...
  create_table 'quiz_result_histories', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
  ...
  create_table 'quiz_user_groups', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[quiz_id user_group_id], name: 'index_quiz_user_groups_on_quiz_id_and_user_group_id', unique: true
  ...
  create_table 'user_group_memberships', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[user_id user_group_id], name: 'index_user_group_memberships_on_user_id_and_user_group_id', unique: true
